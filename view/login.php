                    ...
                    <form action="./">
                        ...
                        <div class="d-flex justify-content-between align-items-center pdb-r">
                            ...
                            <div class="forget-link fz-6">
                                <a href="page-reset.html">Mot de passe oublié?</a>
                            </div>
                        </div>
                        <button class="btn btn-primary btn-block btn-md">Se connecter</button>
                    </form>
                    
                </div>
                <div class="ath-note text-center tc-light">
                    Vous n'avez pas encore de compte? <a href="index.php?p=register"> <strong>Inscrivez vous ici..</strong></a>
                </div>
            </div>
        </main>
