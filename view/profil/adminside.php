 <!-- partial -->
 <div class="container-fluid page-body-wrapper " style="background:#0f1531;">
        <!-- partial:partials/_sidebar.html -->
        <nav class="sidebar sidebar-offcanvas dark" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  <span class="font-weight-bold mb-2"><?php echo $mail; ?><i class="mdi mdi-bookmark-check text-success nav-profile-badge"></i></span>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="#">Retraits en attente</a></li>
                  <li class="nav-item"> <a class="nav-link" href="#">Retraits Validés</a></li>
                  <li class="nav-item"> <a class="nav-link" href="#">Retraits Annulés</a></li>
                </ul>
              </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="user">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="#">Liste des Utilisateurs</a></li>
                </ul>
              </div>
