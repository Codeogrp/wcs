...
<?php include("header.php");  ?>
			...
			<div class="header-banner bg-theme-grad">
                                ...
                                <div class="row align-items-center justify-content-center justify-content-lg-between">
                                        ...
                                        <div class="token-status token-status-s3 round bg-theme-alt tc-light">
                                            ...
                                            <div class="token-info token-info-s1">
                                                <div class="token-info-item token-info-item-s1">
                                                    ...
                                                    <div class="token-info-item-list">
                                                        <span>Crypto:</span>
                                                        <h4><em class="fab fa-bitcoin"></em>BTC</h4>
                                                    </div>
                                                </div>
                                                <div class="token-info-item token-info-item-s1">
                                                    <span>Stock actuellement <br class="d-none d-md-block"> disponible :</span>
                                                    <h4>$90,000 </h4>
                                                </div>
                                            </div>
                                            <div class="token-action token-action-s2 flex-wrap flex-sm-nowrap">
                                                <a href="#" class="btn btn-md btn-secondary">Visiter le site</a>
                                                <div class="token-min-s2">
                                                    <span>Minimum à acheter:</span> 
                                                    <span>$50.00</span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-sm-10 text-center text-lg-left">
                                        <div class="banner-caption cpn tc-light">
                                            <div class="cpn-head">
                                                <h1 class="title title-xl-2 title-semibold">Faites un pas sérieux vers votre liberté financière.</h1>
                                            </div>
                                            <div class="cpn-text">
                                                <p class="lead-s2">Nous créons un environnement de services financiers adaptés à vos besoins.</p>
                                            </div>
                ...
                <div class="" data-video="" data-overlay="theme" data-opacity="80" data-cover="images/bg.jpg"></div>
            </div>
			<!-- .header-banner @e -->
		</header>
    
        <main class="nk-pages">
            <!--<section class="section pb-0 text-center">
                                        ...
                                        <div class="col-md-5">
                                            <div class="feature">
                                                <div class="feature-text">
                                                    <h5 class="title title-sm">Fair Economy</h5>
                                                    <p>Collected fees are trivial example, which</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="feature">
                                                <div class="feature-text">
                                                    <h5 class="title title-sm">Performance</h5>
                                                    <p>Collected fees are trivial example, which</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <a class="btn btn-grad" href="#">Buy token Now</a>
                                </div>
                            </div>
                        </div>
                    </div><!-- .block @e -->
